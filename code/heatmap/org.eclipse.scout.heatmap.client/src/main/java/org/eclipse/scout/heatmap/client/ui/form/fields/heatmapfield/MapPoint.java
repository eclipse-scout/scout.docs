...
public class MapPoint {
  ...
  public boolean equals(Object obj) {
    ...
    if (m_x == null) {
      if (other.m_x != null) return false;
    }
    else if (!(m_x.compareTo(other.m_x) == 0)) return false;
    if (m_y == null) {
      if (other.m_y != null) return false;
    }
    else if (!(m_y.compareTo(other.m_y) == 0)) return false;
    return true;
  }
