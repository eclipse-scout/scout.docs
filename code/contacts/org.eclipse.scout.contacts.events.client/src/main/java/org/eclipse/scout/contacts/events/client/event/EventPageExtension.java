 ...
 * @author mzi
 */
public class EventPageExtension extends AbstractPageWithNodesExtension<OrganizationDetailsNodePage> {

  public EventPageExtension(OrganizationDetailsNodePage owner) {
    super(owner);
  }
