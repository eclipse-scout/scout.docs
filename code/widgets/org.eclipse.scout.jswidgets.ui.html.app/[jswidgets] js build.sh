...
command -v npm >/dev/null 2>&1 || {
  echo >&2 "npm cannot be found. Make sure Node.js is installed and the PATH variable correctly set. See the content of this script for details. Aborting."
  exit 1
}
...
cd widgets/org.eclipse.scout.jswidgets.ui.html.app || exit 1
