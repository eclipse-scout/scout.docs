 ...
 */
import {arrays, Form, MessageBoxes, models} from '@eclipse-scout/core';
...
export default class BreadcrumbBarFieldForm extends Form {
  ...
  _onBreadcrumbAction(event) {
    MessageBoxes.openOk(this, this.session.text('BreadcrumbClickedX', event.source.ref), scout.Status.Severity.INFO).then();
  }
