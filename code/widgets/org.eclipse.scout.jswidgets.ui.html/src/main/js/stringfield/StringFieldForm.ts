 ...
 */
import {Event, Form, FormModel, InitModelOf, MessageBox, models, scout, StringField, StringFieldSelectionChangeEvent, ValueFieldFormatter, ValueFieldParser} from '@eclipse-scout/core';
...
export class StringFieldForm extends Form {
  ...
  protected override _init(model: InitModelOf<this>) {
    ...
    multilineTextField.on('propertyChange:value', event => {
      ...
      stringField.getParentGroupBox().rerenderControls();
    });
