...
export class GridDataBox extends GroupBox {
  ...
  protected override _init(model: InitModelOf<this>) {
    ...
    this.widget('MinWidthInPixelField').on('propertyChange:value', event => this._updateGridDataByEvent(event));
    this.widget('MinHeightInPixelField').on('propertyChange:value', event => this._updateGridDataByEvent(event));
  ...
  reloadGridData() {
    ...
    this.widget('MinWidthInPixelField').setValue(gridData.minWidthInPixel);
    this.widget('MinHeightInPixelField').setValue(gridData.minHeightInPixel);
  ...
  protected _fillGridDataByEvent(gridData: GridData, event: PropertyChangeEvent<any, FormField>) {
    ...
    } else if (event.source.id === 'MinWidthInPixelField') {
      gridData.minWidthInPixel = event.newValue;
    } else if (event.source.id === 'MinHeightInPixelField') {
      gridData.minHeightInPixel = event.newValue;
