...
import {SwitchFormWidgetMap} from '../index';
import model from './SwitchFormModel';

export class SwitchForm extends Form {
  declare widgetMap: SwitchFormWidgetMap;
  ...
  protected override _init(model: InitModelOf<this>) {
    ...
    this.widget('WidgetActionsBox').setField(switch_);
    this.widget('EventsTab').setField(switch_);
  }
}
