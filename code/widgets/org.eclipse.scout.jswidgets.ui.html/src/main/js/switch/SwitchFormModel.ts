 ...
 */
import {Button, CheckBoxField, FormFieldMenu, FormModel, GroupBox, SequenceBox, SmartField, StringField, Switch, TabBox, TabItem, WidgetField} from '@eclipse-scout/core';
import {EventsTab, EventsTabWidgetMap, GridDataBox, GridDataBoxWidgetMap, SwitchDisplayStyleLookupCall, WidgetActionsBox, WidgetActionsBoxWidgetMap} from '../index';
...
export type SwitchFormWidgetMap = {
  'MainBox': GroupBox;
