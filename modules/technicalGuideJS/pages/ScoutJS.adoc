...
= Eclipse ScoutJS: Technical Guide
...
NOTE: This is the guide to Scout JS, the JavaScript part of Eclipse Scout. If you are looking for the Java part please see the technical guide for Scout Classic.
// TODO: add link
...
[[img-header-background, Figure 000]]
