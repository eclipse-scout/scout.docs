...
in xref:technical-guide:scout-classic/DataObject.adoc#cha-namespace-and-itypeversion[Data Objects: Namespace and ITypeVersion] in the technical documentation.
...
xref:technical-guide:scout-classic/Icons.adoc[]
...
For more information about the filter API and the filter field see xref:technical-guide:scout-js/widget-reference.adoc#filter-field[Filter Field].
