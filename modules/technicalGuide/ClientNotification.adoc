...
----
include::{codedir}/org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/notification/MessageNotificationHandler.java[tags=notificationHandler]
----
...
----
include::{codedir}/org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/notification/MessageNotificationHandler.java[tags=handleNotification]
----
