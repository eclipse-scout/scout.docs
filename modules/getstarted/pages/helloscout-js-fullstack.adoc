...
To learn more about Scout JS, we recommend having a look at the other Scout JS Hello World tutorials and the xref:technical-guide:scout-js/overview.adoc[Scout JS Technical Guide].
