...
NOTE: If you don't know what Scout Classic is yet, please read xref:getstarted:getstarted.adoc[], first.
...
To gain experience working with Scout, we recommend going through the xref:oneday:tutorial.adoc[].
