...
The Group.CollapseStyle property is applied on the custom header, that can be used in the group. Without the property set, the default CollapsStyle is CollapsStyle.LEFT.
