...
image::{imgsdir}/sdk_create_new_personpage_wizard_Intellij.png[]
[[img-contacts_new_person_page_Intellij]]
.Add the person page to the "Contacts" application in IntelliJ.
image::{imgsdir}/sdk_new_personpage_wizard_Intellij.png[]
...
image::{imgsdir}/sdk_new_page_column_contacts_IntelliJ.png[]
...
.Adding a column to the person page table in IntelliJ.
image::{imgsdir}/sdk_new_page_column_personid_Intellij.png[]
