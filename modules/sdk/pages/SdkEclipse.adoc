...
include::partial$SdkWizardProject.adoc[]
...
include::partial$SdkWizardPage.adoc[]
...
include::partial$SdkWizardForm.adoc[]

[[sec-sdk_content_assist]]
=== Scout Content Assistance

include::partial$SdkContentAssist.adoc[]
...
include::partial$SdkEditorNlsContentAssist.adoc[]
...
include::partial$SdkEditorNlsNewEntry.adoc[]
...
include::partial$SdkEditorNls.adoc[]

include::partial$SdkEclipseInstallation.adoc[]
