...
xref:getstarted:getstarted.adoc[], first.
...
[source,js]
----
include::example$webpack.config.js[]
----
...
[source,html]
----
include::example$res/index.html[]
----
...
[source,js]
----
include::example$src/helloworld.js[]
----
...
[source,less]
----
include::example$src/helloworld.less[]
----
...
[source,js]
----
include::example$src/desktop/DesktopModel.js[]
----
...
[source,js]
----
include::example$src/desktop/Desktop.js[]
----
...
[source,js]
----
include::example$src/greeting/HelloFormModel.js[]
----
...
[source,js]
----
include::example$src/greeting/HelloForm.js[]
----
...
[source,ruby]
----
include::example$gitignore[tag=include]
----
...
If you are interested in adding a REST backend you should have a look at xref:helloscout_js_fullstack:helloscout-js-fullstack.adoc[].
...
a look at the xref:technicalGuideJS:ScoutJS.adoc[].
