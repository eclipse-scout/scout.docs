:ScoutContributionGuidelines: https://wiki.eclipse.org/Scout/Contribution_Guidelines
...
This Branch is not used anymore. Please refer to link:{ScoutContributionGuidelines}[Scout/Contribution Guidelines] which branch is suitable for you.
