...
TIP: The JavaScript build could fail in case the installed Node.js could not be found or is too old.
Then follow the instructions in the section <<Prerequisites>> and check the IntelliJ settings in `File | Settings | Languages & Frameworks | Node.js and NPM`.
