...
The Scout documentation has been moved to AsciiDoctor. The documentation is currently hosted on GitHub and the output of the documentation build is available on github.io: link:{techdoc}[Technical Guide].
