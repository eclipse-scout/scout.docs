...
==== Simrel 2018-06 (9.0.x) Release Expected in June 2018
...
The new property `bodyVisible` defines if the body can be visible at all (means there is a content and the user can collapse/open the group) or should be hidden (even if there is a body with content defined in the model).
