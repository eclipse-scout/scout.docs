...
* http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.eclipse.scout.rt%22%20AND%20v%3A%228.0.0.009_Photon%22[8.0.0.009_Photon] on _Maven Central_
* https://mvnrepository.com/artifact/org.eclipse.scout.rt/org.eclipse.scout.rt/8.0.0.009_Photon[8.0.0.009_Photon] on _mvnrepository.com_
...
<dependency>
    ...
    <version>8.0.0.009_Photon</version>
    <type>pom</type>
    <scope>import</scope>
</dependency>
----
...
==== Demo Applications
The demo applications for this version can be found on the https://github.com/BSI-Business-Systems-Integration-AG/org.eclipse.scout.docs/tree/features/version/8.0.0.009_Photon[features/version/8.0.0.009_Photon] branch of our docs repository on GitHub.
