...
The latest version of this release is: _8.0.0.014
...
==== SimRel 2018-09 (8.0.100) Release Expected on September, 2018
...
* http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.eclipse.scout.rt%22%20AND%20v%3A%228.0.0.016_Simrel_2018_09_M2%22[8.0.0.016_Simrel_2018_09_M2] on _Maven Central_
* https://mvnrepository.com/artifact/org.eclipse.scout.rt/org.eclipse.scout.rt/8.0.0.016_Simrel_2018_09_M2[8.0.0.016_Simrel_2018_09_M2] on _mvnrepository.com_
...
<dependency>
    ...
    <version>8.0.0.016_Simrel_2018_09_M2</version>
    <type>pom</type>
    <scope>import</scope>
</dependency>
----
...
http://download.eclipse.org/scout/releases/8.0/8.0.0/016_Simrel_2018_09_M2/

==== Demo Applications
The demo applications for this version can be found on the https://github.com/BSI-Business-Systems-Integration-AG/org.eclipse.scout.docs/tree/features/version/8.0.0.016_Simrel_2018_09_M2[features/version/8.0.0.016_Simrel_2018_09_M2] branch of our docs repository on GitHub.
