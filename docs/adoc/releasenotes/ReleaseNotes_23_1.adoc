...
Typing allows your IDE to better assist with code completion during development and only suggests methods and properties for an object that actually exist. +
+
