...
Eclipse Scout 7.0 is a preview of the Eclipse Oxygen release. The latest public build on this branch is _6.1.0.B006_. The official release for Eclipse Oxygen is Eclipse Scout 7.0 and will be released in June 2017.
