...
=== Description
CodeTypes are used in https://wiki.eclipse.org/Scout/Concepts/SmartField[SmartField] to let the user choose between a finite list of values. The value stored by the field correspond to the key of the selected code.
