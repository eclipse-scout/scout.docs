...
| image:{imgsdir}/icon_refresh.png[]
| Refresh NLS Project
| Reload the content of the editor.

| image:{imgsdir}/icon_find_obj.png[]
...
| image:{imgsdir}/icon_fileadd_pending.png[]
| New language...
| Opens the {sdk_wizard_language}

| image:{imgsdir}/icon_import.png[]
| Import...
| Import the NLS entries of an external file

| image:{imgsdir}/icon_export.png[]
| Export...
