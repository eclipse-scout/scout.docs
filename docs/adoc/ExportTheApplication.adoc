...
Otherwise, check out the configuration process described in the http://tomcat.apache.org/tomcat-9.0-doc/ssl-howto.html[Tomcat Documentation] to enable SSL/TLS.
