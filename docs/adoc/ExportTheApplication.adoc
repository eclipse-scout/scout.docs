...
After a restart of Tomcat you should then be able to access Tomcat on https://localhost:8443/manager/html[https://localhost:8443/manager/html,window=_blank]
...
to Tomcat it should become available on https://localhost:8443/org.eclipse.scout.apps.helloworld.ui.html[https://localhost:8443/org.eclipse.scout.apps.helloworld.ui.html,window=_blank].
