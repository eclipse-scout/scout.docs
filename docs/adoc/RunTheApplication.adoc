...
After having successfully started the Scout backend and frontend servers the Hello World application can then be accessed by navigating to http://localhost:8082[http://localhost:8082,window=_blank] in your favorite web browser.
