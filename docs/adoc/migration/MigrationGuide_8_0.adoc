...
* <<Moved classes from org.eclipse.scout.rt.shared.mail to new module to org.eclipse.scout.rt.mail (since 8.0.100)>>
...
=== Moved classes from org.eclipse.scout.rt.shared.mail to new module to org.eclipse.scout.rt.mail (since 8.0.100)
The following classes were moved from `org.eclipse.scout.rt.shared.mail` to a new module named `org.eclipse.scout.rt.mail` to a package with the same module name:
