...
. In the pom.xml of your parent project change the version of the parent maven_rt_plugin_config-master to 3.12.7. Additionally, update your Scout dependencies to the most recent Scout 10 version.
