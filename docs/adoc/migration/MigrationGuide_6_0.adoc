...
The following changes were made after the inital 6.0 release. Follow these instructions when updating to a _service release_.
...
** Attachments must be used within the `IHtmlField`'s value as `src="binaryResource:test.zip"` (instead of `src="test.zip"`). Append `binaryResource:` prefix where attachments are used.
...
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_bg.properties[ScoutTexts_bg.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_cs.properties[ScoutTexts_cs.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_da.properties[ScoutTexts_da.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_de_DE.properties[ScoutTexts_de_DE.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_de.properties[ScoutTexts_de.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_el.properties[ScoutTexts_el.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_es.properties[ScoutTexts_es.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_fi.properties[ScoutTexts_fi.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_fr_BE.properties[ScoutTexts_fr_BE.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_fr.properties[ScoutTexts_fr.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_hr.properties[ScoutTexts_hr.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_hu.properties[ScoutTexts_hu.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_it.properties[ScoutTexts_it.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_ja.properties[ScoutTexts_ja.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_nl_BE.properties[ScoutTexts_nl_BE.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_nl.properties[ScoutTexts_nl.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_no.properties[ScoutTexts_no.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_pl.properties[ScoutTexts_pl.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_pt_br.properties[ScoutTexts_pt_br.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_ru.properties[ScoutTexts_ru.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_se.properties[ScoutTexts_se.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_sk.properties[ScoutTexts_sk.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_sl.properties[ScoutTexts_sl.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_sr.properties[ScoutTexts_sr.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_tr.properties[ScoutTexts_tr.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_zh_TW.properties[ScoutTexts_zh_TW.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts_zh.properties[ScoutTexts_zh.properties]
* git-link:docs/adoc/migration/ScoutTexts/ScoutTexts.properties[ScoutTexts.properties]
