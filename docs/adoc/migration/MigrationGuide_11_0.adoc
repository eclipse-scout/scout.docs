...
... js build.sh: https://git.eclipse.org/c/scout/org.eclipse.scout.sdk.git/plain/scout-helloworld-app/src/main/resources/archetype-resources/{dus}rootArtifactId{dus}.ui.html/js%20build.sh?h=releases/11.0[sample content]
... js build.cmd: https://git.eclipse.org/c/scout/org.eclipse.scout.sdk.git/plain/scout-helloworld-app/src/main/resources/archetype-resources/{dus}rootArtifactId{dus}.ui.html/win%20js%20build.cmd?h=releases/11.0[sample content]
