...
In case you first need to download and install a JDK we recommend to work with either the http://www.oracle.com/technetwork/java/javase/downloads/index.html[Oracle JDK,window=_blank] or the http://openjdk.java.net/install/[Open JDK,window=_blank].
For Maven, head over to the https://maven.apache.org/[Maven project page,window=_blank].
...
https://www.eclipse.org/downloads/[www.eclipse.org/downloads,window=_blank]
