...
All source files of the book including the Scout projects described in the book are available on https://github.com/bsi-software/org.eclipse.scout.docs[Github].
