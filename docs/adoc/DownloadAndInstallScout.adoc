...
As shown in <<img-scout_download>>, the Scout package is available as a 32 bit and a 64 bit package.
Make sure to pick the package that matches your JDK installation (x64).
