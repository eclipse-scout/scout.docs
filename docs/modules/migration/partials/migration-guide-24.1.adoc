...
If your JAX-WS service uses bindings in _jaxb-binding.xml_ or _jaxws-binding.xml_ the namespace attribute must be updated.
Use the new namespace _https://jakarta.ee/xml/ns/jaxb_.
