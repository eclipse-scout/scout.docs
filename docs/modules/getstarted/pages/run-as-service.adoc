...
Java 24 is required to run the Scout applications

  apt install openjdk-24-jdk

Run

  update-alternatives --config java

and select Java 24 as default.
...
Environment=JAVA_BIN=/usr/lib/jvm/java-24-openjdk-amd64/bin/java
