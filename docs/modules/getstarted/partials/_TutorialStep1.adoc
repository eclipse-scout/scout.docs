...
To create the initial code for the "`Contacts`" application with IntelliJ, click `File | New | Project...` and then select `Scout` on the left side.
Adjust the project name fields as shown in <<img-sdk_new_project_tutorial_Intellij>> and make sure the user interface language is set to Java.

If you are using Eclipse, make sure your workspace is emtpy. Either create a new one or close or delete the existing projects using the context menu "`Close Projects`" or "`Delete`".
Then use the [wizard]_New Scout Project_ wizard to create the initial code.
Adjust the project name fields as shown in <<img-sdk_new_project_tutorial>> and make sure the programming language of the user interface is set to Java.
...
image::common:sdk_new_project_tutorial_Intellij.png[]
...
image::common:app_contacts_package_explorer_initial_Intellij.png[]
...
image::common:eclipse_open_type_Intellij.png[]
...
image::common:sdk_rename_package_Intellij.png[]
...
image::common:sdk_new_text_entry_contact_wizard_IntelliJ.png[]
