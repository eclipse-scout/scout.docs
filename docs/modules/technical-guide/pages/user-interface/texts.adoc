...
If you decide to store your translated texts in .properties files, you might want to use the https://wiki.eclipse.org/Scout/SDK/NLS_Editor[NLS Editor] to edit them.
