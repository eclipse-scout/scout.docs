...
The Java API for XML-Based Web Services (JAX-WS) is a Java programming language API for creating web services.
JAX-WS is one of the Java XML programming APIs, and is part of the Java EE platform.
...
* provides an up front port type _EntryPoint_ to enforce for authentication, and to run web requests in a xref:technical-guide:common-concepts/run-context.adoc[]
...
It is implementor neutral, and was tested with with the following implementations:

* _JAX-WS RI_ (reference implementation)
* _JAX-WS METRO_
* _Apache CXF_

The integration requires you to bundle the JAX-WS implementor with your application.
When publishing webservices, it therefore is easiest to ship with a separate implementor:
Declare a respective Maven dependency in your webapp project - that is the Maven module ending in `.app`.
...
A generally applicable configuration cannot be given, because the effective configuration depends on the implementor you choose.
However, if _JAX-WS RI_ is sufficient, you do not have to specify an implementor at all because already contained in JRE.
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.pom.dependency.metro]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.pom.dependency.cxf]
----

==== Configure JAX-WS servlet

This section describes the configuration of the entry point Servlet to publish webservices.
If working with webservice consumers only, no configuration is required.

Similar to the pom.xml as described in <<jaxws.implementor.dependency>>, the way the servlet needs to be registered differs from implementor to implementor.
The following <<lst-jaxws.registration.metro>> show a sample configuration for _JAX-WS METRO_ and <<lst-jaxws.registration.cxf>> for _Apache CXF_.

[[lst-jaxws.registration.metro]]
.Registration for _JAX-WS METRO_ Servlet
[source,java]
----
@Order(5)
...
[[lst-jaxws.registration.cxf]]
.Registration for _Apache CXF_ Servlet
[source,java]
----
/**
 * JAX-WS Apache CXF.
...
image::common:jaxws_modularization.png[]
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.pom.scoutversion]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.pom.single-wsdl-file-per-module]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.pom.multiple-wsdl-files-per-module]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.pom.multiple-binding-files]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.bindingfile.global-binding]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.bindingfile.ws-binding]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.bindingfile.xs-binding]
----
...
image::common:jaxws_interaction_entrypoint_porttype.png[]
...
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.entrypoint.definition]
----
...
|runContextProducer
|Indicates which xref:technical-guide:common-concepts/run-context.adoc[] to use to run authenticated webservice requests. By default, `ServerRunContextProducer` is used, which is based on a session cache, and enforces to run in a new transaction.
|===
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.pingws.entrypoint.definition]
----
...
.generated artifacts
image::common:jaxws_example_pingws_artifacts_generated.png[]
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws_pingws_handler_file]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.pingws.porttype]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.handler.ipaddressfilter]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.statepropagation.handler1]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.statepropagation.handler2]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.statepropagation.porttype]
----
...
Scout's JAX-WS integration already provides complete support for reading a correlation ID from the HTTP header named `X-Scout-Correlation-Id` of the incoming web service request and propagates it to the xref:technical-guide:common-concepts/run-context.adoc[] that executes the actual service operation. A new correlation ID is created if the HTTP header is empty or missing.
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.pingwsWithCorrelationId.entrypoint.definition]
----
...
The registration of webservice endpoints depends on the implementor you use.
In the following, an example for _JAX-WS METRO_ and _Apache CXF_ is given.
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws_registration_metro_sunjaxws.xml]
----

[[jaxws.registration.endpoints.cxf]]
==== Apache CXF

During startup, _Apache CXF_ looks for the config file as specified in the registration via 'config-location'. See <<lst-jaxws.registration.cxf>> for more information.

.WEB-INF/cxf-jaxws.xml
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws_registration_cxf_jaxws.xml]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient1]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient2]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient.call_1]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient.call_2]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient.call_3]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient.call_4]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient3]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.wsclient4]
----
...
|Adapter to convert a _xsd:dateTime_ to a `Calendar` and vice versa. For both directions, the timezone information is not lost. Use this adapter if you expect to work with dates from various timezones without losing the local time. If the UTC (Zulu-time) is sufficient, use `UtcDateTimeAdapter` instead.
|===
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/resources/WEB-INF/wsdl/PingWebService.wsdl[]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.endpointinterface]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.entrypoint]
----
...
[source,java,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.java[tags=jaxws.example.porttype.bean]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.eclipseide.apt.settings/org.eclipse.jdt.core.prefs]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.eclipseide.apt.settings/org.eclipse.jdt.apt.core.prefs]
----
...
[source,xml,indent=0]
----
include::common:example$org.eclipse.scout.docs.snippets/src/main/java/org/eclipse/scout/docs/snippets/JaxWsSnippet.txt[tags=jaxws.eclipseide.apt.factorypath]
----
