...
So if you don't have it yet, visit the https://nodejs.org/dist/latest-v24.x/[Node.js download site], choose the package for your platform and install it on your local machine.
...
Scout uses https://pnpm.io/[pnpm] as package manager.
