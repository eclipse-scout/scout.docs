...
== CollapseStyle for Group CustomHeader

The Group.CollapseStyle property is applied on a custom header, that can be used in the group. Without the property set, the default CollapseStyle is CollapseStyle.LEFT.
