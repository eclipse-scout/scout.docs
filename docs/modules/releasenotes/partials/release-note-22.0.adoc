...
Multipart support on client and server side was added.
See the xref:technical-guide:working-with-data/data-object.adoc#cha-rest-multipart[technical documentation] for more information.
...
Basic OpenTelemetry support for signal metric was added.
See the xref:technical-guide:common-concepts/observability.adoc[technical documentation] for more information.
