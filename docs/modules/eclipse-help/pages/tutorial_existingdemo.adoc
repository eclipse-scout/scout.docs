...
* `JRE Location`: Path to your Java 21
...
If you do not see the working-sets, you might need to select "menu:Top Level Elements[Working Sets]" from the Menu as displayed in <<img-workingsets_top_level>>
