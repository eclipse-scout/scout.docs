...
Before you can install the Scout SDK make sure that you have a working Java Development Kit (JDK) installation version 25.
...
Please note that the Scout officially only supports Java 25.
