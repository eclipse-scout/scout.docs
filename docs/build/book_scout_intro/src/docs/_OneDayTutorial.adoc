...
The goal of this tutorial application is to learn about the most prominent features of the Eclipse Scout framework that is based on a fully functioning application. 
The application is still kept small.footnote:[
...
enough to complete this tutorial within 
application covers additional aspects of the Eclipse Scout framework.
The presented demo application borrows from a Scout tutorial published 2012 in the German _Java Magazin_.footnote:[
...
Github.footnote:[
"`Contacts`" on Github: https://github.com/bsi-software/org.eclipse.scout.docs/tree/releases/6.0.x/code/contacts
],
...
Further information regarding logging in Eclipse Scout is available on the SLF4J home page and in the Scout wikifootnote:[
