...
TODO: source code of demo app for class WorkOutline
...
* Remove entry `SettingsOutline.class` from the return value of method `getConfiguredOutlines`
* Change FileMenu to QuickAccesMenu (source code)
* Change BookmarkMenu to Options (source code)
* Change HelpMenu to UserMenu (source code)

TODO: source code of demo app for reduced class Desktop
