...
[[lst-tinyservlet.index_html]]
[source,html]
.The [java]+index.html+ start page for the tiny servlet application.
----
TODO [7.0] jbr: include was {codedir}/tinyservlet/index.html[]
----


[[lst-tinyservlet.web_xml]]
[source,xml]
.The [java]+web.xml+ file of the tiny servlet application.
----
TODO [7.0] jbr: include was {codedir}/tinyservlet/WEB-INF/web.xml[]
----


[[lst-tinyservlet.TinyServlet]]
[source,java]
.The complete [java]+TinyServlet+ source code.
----
TODO [7.0] jbr: include was {codedir}/tinyservlet/WEB-INF/sources/TinyServlet.java[]
----
