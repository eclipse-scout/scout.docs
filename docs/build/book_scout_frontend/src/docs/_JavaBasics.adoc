...
----
TODO include was {codedir}/tinyservlet/index.html[]
----
...
----
TODO include was {codedir}/tinyservlet/WEB-INF/web.xml[]
----
...
----
TODO include was {codedir}/tinyservlet/WEB-INF/sources/TinyServlet.java[]
----
