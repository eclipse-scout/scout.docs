...
** In folder `src/main/java` and package `org.eclipse.scout.apps.helloworld.client.helloworld`
*** The `MyForm` form class
* In Maven module *helloworld.shared*
** In folder `src/main/java` and package `org.eclipse.scout.apps.helloworld.shared.helloworld`
*** The `IMyFormService` service interface
*** The `ReadMyPermission` permission class
*** The `UpdateMyPermission` permission class
** In folder `src/generated/java` and package `org.eclipse.scout.apps.helloworld.shared.helloworld`
*** The `MyFormData` form data class
* In Maven module *helloworld.server*
** In folder `src/main/java` and package `org.eclipse.scout.apps.helloworld.server.helloworld`
*** The `MyFormService` service class
