...
After the Setup of the "Scout Demo App", a lot of projects are materialized in the workspace (see the screenshot in figure <<img-oomph_workingsets>>).
The projects are oranized in three working sets:
