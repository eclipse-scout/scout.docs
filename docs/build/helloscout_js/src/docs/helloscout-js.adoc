...
NOTE: If you don't know what Scout JS is yet, please read the https://eclipsescout.github.io/{doc-short-version}/get-started.html[Get Started Guide] first.
...
If you are interested in adding a REST backend you should have a look at https://eclipsescout.github.io/{doc-short-version}/helloscout-js-fullstack.html[Hello Scout JS Full Stack Tutorial].
