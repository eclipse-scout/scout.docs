...
== _Hello World_ with Plain Scout JS

In this chapter we will create a _plain_ Eclipse Scout JS application,
that is, an application that does not require Maven or Java, only Node.js.

When the user opens this application in the browser, there is a text field and a button.
Once the user enters some text and presses the button, the application displays a message box including that text.

The goal of this chapter is to provide a first impression of the Scout JS framework.
We will start by getting the application running and then take a look at the code.

=== Prerequisites

Make sure you have https://nodejs.dev[Node.js] 12 or higher (with npm 6.9 or higher) installed.

=== Get the Code

:scoutjs-helloworld: https://github.com/bsi-software/org.eclipse.scout.docs/tree/releases/{doc-short-version}/code/helloscoutjs

For now, you have to manually recreate the {scoutjs-helloworld}[helloworld] folder with all its files
or clone the whole https://github.com/bsi-software/org.eclipse.scout.docs.git[docs] repository,
checkout branch `releases/{doc-short-version}` and use or copy that folder from your working tree.
...
[source,json]
----
include::{codedir}/helloscoutjs/package.json[]
----
...
[source,js]
----
include::{codedir}/helloscoutjs/webpack.config.js[]
----
...
[source,html]
----
include::{codedir}/helloscoutjs/res/index.html[]
----
...
[source,js]
----
include::{codedir}/helloscoutjs/src/helloworld.js[]
----
...
[source,less]
----
include::{codedir}/helloscoutjs/src/helloworld.less[]
----
...
[source,js]
----
include::{codedir}/helloscoutjs/src/desktop/DesktopModel.js[]
----
...
[source,js]
----
include::{codedir}/helloscoutjs/src/desktop/Desktop.js[]
----
...
[source,js]
----
include::{codedir}/helloscoutjs/src/greeting/HelloFormModel.js[]
----
...
[source,js]
----
include::{codedir}/helloscoutjs/src/greeting/HelloForm.js[]
----
...
a look a the {technical-guide-js}[Scout JS Technical Guide]

In case you should get stuck somewhere and need help, try to get answers by searching the web.
And if despite reasonable efforts this approach does not help, contact us on the {scout-forum}[Scout forum] or on https://stackoverflow.com/tags/eclipse-scout[Stack Overflow].
Should you have solved issues on your own, please consider sharing your findings in the forum
as this can help other folks too.
