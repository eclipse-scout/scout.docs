...
<<sec-sdk_motivation>> describes the goals and benefits of the tooling included.
...
include::{sdkdir}/SdkScoutTooling.adoc[]
...
include::{sdkdir}/SdkWizardProject.adoc[]
...
include::{sdkdir}/SdkWizardPage.adoc[]
...
include::{sdkdir}/SdkWizardForm.adoc[]

[[sec-sdk_content_assist]]
=== Scout Content Assistance

include::{sdkdir}/SdkContentAssist.adoc[]
...
include::{sdkdir}/SdkEditorNlsContentAssist.adoc[]
...
include::{sdkdir}/SdkEditorNlsNewEntry.adoc[]
...
include::{sdkdir}/SdkEditorNls.adoc[]

include::{sdkdir}/SdkEclipseInstallation.adoc[]