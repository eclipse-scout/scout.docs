...
First of all you need to decide what programming language you want to use for the user interface.
...
In addition to the programming language, you should think about whether you want to go full stack (front end, back end) or just focus on one tier.
For example, you could use Scout JS on the front end, Scout on the back end and a REST api for the communication.
Or maybe you prefer to use an existing REST api and just want to use the powerful Scout widgets for the front end.
Or maybe you don't need a back end at all because you plan to implement an offline app.
...
http://eclipsescout.github.io/{scout-short-version}/helloscout.html[Hello Scout Classic] +

http://eclipsescout.github.io/{scout-short-version}/helloscout-js.html[Hello Scout JS]
...
A popular one is https://www.jsdelivr.com/.
...
If you want to learn more about using a CDN, please see http://eclipsescout.github.io/{scout-short-version}/helloscout-cdn.html[Hello Scout for CDN].
