...
To access this application you can switch to the `Manager App` with a click on the corresponding button on the right-hand-side as shown in <<img-tomcat_install>>.
