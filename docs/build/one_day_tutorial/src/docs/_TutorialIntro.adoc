...
Alternatively, you can also view the source code of the "`Contacts`" demo application on https://github.com/eclipse-scout/scout.docs/tree/{git-branch}/code/contacts[Github].
