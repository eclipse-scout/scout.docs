...
An extended version of "`Contacts`" is available as a Scout sample application on link:https://github.com/eclipse-scout/scout.docs/tree/{git-branch}/code/contacts[Github].
