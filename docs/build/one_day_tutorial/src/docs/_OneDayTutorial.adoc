...
If you have successfully completed the http://eclipsescout.github.io/{scout-short-version}/helloscout.html[Hello Scout Tutorial] you should have a running Eclipse Scout installation.
