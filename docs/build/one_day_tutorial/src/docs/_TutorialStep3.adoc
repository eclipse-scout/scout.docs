...
image::{imgsdir}/contacts_tutorial_maven_modules_Intellij.png[]
...
image::{imgsdir}/contacts_tutorial_update_server_modules_Intellij.png[]
...
** Enter `org.eclipse.scout.contacts.server.sql` into the [field]_Name_ field and hit btn:[Enter]
* For Eclipse:
...
image::{imgsdir}/contacts_tutorial_copied_db_classes_intellij.png[]
