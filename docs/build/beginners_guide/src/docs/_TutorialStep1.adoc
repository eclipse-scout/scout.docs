...
* Rename FileMenu to `QuickAccesMenu`, let `getConfiguredText` return "Quick Access" and delete the remaining content.
...
<1> In your implementation `QuickAccesMenu` should extend `AbstractMenu`
