...
This tutorial steps also also provides an introduction into the design and implementation complex form layouts with the Scout framework.
...
Inside of class `DetailsBox` create the individual tab contai`DetailsBox`ners "Contact Info", "Work" and "Notes" as as inner classes of the details box according to <<lst-contacts_form_layout>>.
