...
WARNING: This document is based on a past Scout release. Please click https://eclipsescout.github.io/stable/beginners-guide.html[here] for the recent version. +
