...
The implementation of method `getPersonTableData` is provided in <<>>.

[[lst-contacts_fetch_pers, Listing PersonService]]
[source,java]
.Method getPersonTableData to access the database and map the data into a pageData object.
----
