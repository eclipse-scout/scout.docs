...
Database access and populating the pages with actual data from the database is not part of this section but will be covered in <<sec-contacts_jdbc>> in the next tutorial step.
