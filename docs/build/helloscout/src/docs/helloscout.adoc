...
NOTE: If you don't know what Scout Classic is yet, please read the https://eclipsescout.github.io/{doc-short-version}/get-started.html[Get Started Guide] first.
